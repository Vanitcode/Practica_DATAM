...
```{r}
similar5 <- function( a, b, c, d, f, g, h,l, m, n, p, pr) {
  df1 = data.frame(
    "Accommodates" = a,
    "Bathrooms" = b,
    "Bedrooms" = c,
    ...
    "Guests.Included" = g,
    "Extra.People" = h,
    "Review.Scores.Rating" = l,
    "Latitude" =m,
    "Longitude" =n,
    "Square.Meters" =p
  )
  df_apartamento_pca = predict(pr, df1)
  
  d = dist(rbind(df_apartamento_pca, df_pca$x), method="euclidean")
...
```{r}
apartament_example = similar5(2, 1, 2, 4, 97, 4, 3, 85, 40.40452, 176.53494, 75, pr_apart)
```
